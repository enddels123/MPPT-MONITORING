...
function createGauge(id, color, max, unit) {
...
client.on(
  ...
  (topic, message) => {
    ...
    document
      .getElementById('pvPowerScada')
      .textContent =
      d.pv_p + "W";

    document
      .getElementById('pvVoltScada')
      .textContent =
      d.pv_v + "V | " +
      d.pv_i + "A";

    document
      .getElementById('mpptPowerScada')
      .textContent =
      d.charge_p + "W";

    document
      .getElementById('mpptEffScada')
      .textContent =
      d.mppt_eff + "%";

    document
      .getElementById('batSocScada')
      .textContent =
      d.soc + "%";

    document
      .getElementById('batVoltScada')
      .textContent =
      d.bat_v + "V | " +
      d.bat_i + "A";

    document
      .getElementById('loadPowerScada')
      .textContent =
      d.load_p + "W";

    document
      .getElementById('loadVoltScada')
      .textContent =
      d.load_v + "V | " +
      d.load_i + "A";
